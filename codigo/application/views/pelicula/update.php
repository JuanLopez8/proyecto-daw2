...
<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="administrador"):?>
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="<?=base_url()?>pelicula/updatePost" method="POST" enctype="multipart/form-data" name="miForm">
					...
					<div class="modal-body">					
						...
						<label>Género:</label>
							...
							<input type="text" class="form-control form-control-sm" name="fecha" value="<?=$pelicula->fecha?>" id="fecha">
							...
							<input type="hidden" class="form-control form-control-sm" value="<?=$pelicula->id?>" name="id">
							<br>
							<span style="margin-left: 15px;">*</span> Campos obligatiorios
							<br><br>
						<input type="button" class="btn btn-info" value="Actualizar" onclick="validarForm('peli')">
						</div>
					</div>
