...
<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="administrador"):?>
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="<?=base_url()?>pelicula/crearPost" method="POST" enctype="multipart/form-data" name="miForm">
					...
					<div class="modal-body">					
						...
						<label><span>*</span>Nombre:</label>
							...
							<input type="text" class="form-control form-control-sm" name="duracion" id="duracion" required>
							<div id="errorDuracion"></div>

							<label><span>*</span>Fecha:</label>
							<input type="text" class="form-control form-control-sm" name="fecha" id="fecha" required/>
							...
							<br><br>
							<input type="button" class="btn btn-info" value="Crear" onclick="validarForm('peli')">
						</div>
					</div>
