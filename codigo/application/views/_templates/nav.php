		...
		<li class="buscadorLi" >
            <div class="buscador" style="margin-right:100px;">
                <form class="form-inline" style="margin-top: 8px;margin-left: 1%;">
                    <input class="form-control mr-sm-2 inputBusqueda" type="search" onkeyup=" buscarResultados('<?=base_url()?>');" placeholder="Búsqueda..." aria-label="Busqueda..." id="npt" >
                </form>
            </div>
            <div id="divBusqueda" hidden style="width:300px;">
