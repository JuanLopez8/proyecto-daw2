...
<div class="boton-acciones" >
	<form action="<?=base_url()?>usuario/update" method="post">
		<button class="btn btn-primary botonMvl botonMvl1">Editar mi cuenta</button>
		<input type="hidden" name="id" value="<?=$usuario->id ?>" />
	</form>
	<form action="<?=base_url()?>usuario/cambiarImagen" method="post">
		<button class="btn btn-primary botonMvl botonMvl2">Cambiar mi foto de perfil</button>
	</form>

	<button class="btn btn-primary botonMvl botonMvl3" data-toggle="modal" data-target="#modalBorrarCuenta">Eliminar mi cuenta</button>
...
<!---->
	<button class="btn btn-primary botonMvl botonMvl4" data-toggle="modal" data-target="#modalCerrarSesion">Cerrar sesión</button>	
...
<!---->
		...
		<button class="btn btn-primary botonMvl botonMvl5">Cambiar mi contraseña</button>
		<input type="hidden" name="id" value="<?=$usuario->id ?>" />
	</form>
	<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="basico"):?><form action="<?=base_url()?>usuario/upgrade" method="post">
		<button class="btn btn-warning botonMvl botonMvl6">Convertir a premium</button>
...
<h1><b>Perfil de <?=$usuario->nombreUsuario ?>: </b><img src="<?=base_url()?>assets/img/usuarios/<?=$usuario->nombreUsuario?>.jpg" onerror="this.src='<?=base_url()?>assets/img/usuarios/pp.png';" alt="foto de perfil" id="fotoPerf" width="150px" height="150px;"></h1><hr>
		...
		<div>
			...
			<div class="progress" >
				...
				<div class="progress-bar progress-bar-danger" id="dejadas" role="progressbar" style="width:20%">Abandonadas</div>
