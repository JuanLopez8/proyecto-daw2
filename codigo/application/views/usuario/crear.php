		...
		<form action="<?=base_url()?>usuario/crearPost" method="POST" name="miForm">
			...
			<div class="modal-body">
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="nombreUsuario" id="nombreUsuario" required onkeyup="comprobarUsuario()">
					<div id="usuExiste"></div>
					<div id="errorUsuario"></div>
					<label><span>*</span>Contraseña:</label>
					<input type="password" class="form-control form-control-sm" name="clave" id="clave" required>
					<label><span>*</span>Confirmar Contraseña:</label>
					<input type="password" class="form-control form-control-sm" name="claveRepe" id="claveRepe" required onkeyup="compararClaves()">
					<div id="errorClaveRepe"></div>
					...
					<input type="text" class="form-control form-control-sm" name="fnac" id="fnac">
					<div id="errorFecha"></div>
					<label>Descripción:</label>
					<textarea class="form-control form-control-sm" name="descripcion"></textarea>
					<br>
					<span style="margin-left: 15px;">*</span> Campos obligatiorios  <br> <br>
