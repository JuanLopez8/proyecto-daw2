...
<?php if(isset($_SESSION['id']) && isset($musica->usuario_id)):?>
<?php if($_SESSION['id']==$musica->usuario->id):?>
...
<input type="submit" class="btn btn-success" value="Actualizar información de mi música"/>
</form>
<?php endif;?>
<?php endif;?>
...
<?php endif;?>
	...
	<?php endif;?>
		...
		<div class="comentarios">
			...
			<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="administrador"):?>
			<form action="<?=base_url()?>musica/deleteComentario" method="POST">
