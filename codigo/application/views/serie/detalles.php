...
<?php endif;?>
		...
		<span class="tituloB">Número de temporadas: <?=$serie->temporadas?></span>
		<span class="tituloB">Número de capítulos: <?=$serie->capitulos?></span>
		<!-- Valoraciones -->
...
<?php endif;?>
	...
	<?php endif;?>
		...
		<div class="comentarios">
			...
			<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="administrador"):?>
			<form action="<?=base_url()?>serie/deleteComentario" method="POST">
