...
<div class="principal">
    ...
    <!-- Parte de anuncios, que se cargarán dependiendo del rol del usuario -->
        <?php if(!isset($_SESSION['rol']) || isset($_SESSION['rol']) && $_SESSION['rol']=="basico"):?>
    <div class="anuncios">
        <div class="carrusel">
            <!--ANUNCIO1-->
...
<?php if(!isset($_SESSION['rol']) || (isset($_SESSION['rol']) && $_SESSION['rol']=="basico")):?>
     <div class="secundaria" style="width:78%;" id="tabs">
<?php endif;?>
<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="premium" || isset($_SESSION['rol']) && $_SESSION['rol']=="administrador"):?>
     <div class="secundaria" style="width:100%;" id="tabs">
<?php endif;?>
        <ul>
...
<div id="tabs-1">
    <div id="acordeon_1">
        ...
        <h3>Películas</h3>
        <div>
            <div class="principalSerie_section-1 scroll">  
            <div class="containerSeries" >
                    ...
                    <div class="dvSerie">
                        <div class="imgDvSerie">
                            <img class="imagenCaratula" src="<?=base_url()?><?=$masValorada->ruta_caratula?>" onerror="this.src='<?=base_url()?>assets/img/404.png';" alt="Imagen no encontrada" width="100%", height="100%"/>
                        </div>
                        <div class="h4DvSerie">
                        <form action="<?=base_url()?>pelicula/detalles" method="POST">
								<input type="hidden" name="id" value="<?=$masValorada->id?>"/>
								<button type="submit" value="Detalles" class="btnTitulo"><h4><?=$masValorada->nombre?></h4></button>
							</form>
                        </div>
                    </div>
                    <?php endforeach;?>
        ...
        <div class="principalSerie_section-1 scroll">
            ...
            <?php if(isset($seriesMasValoradas) && $seriesMasValoradas!=null):?>
                <?php foreach($seriesMasValoradas as $masValorada):?>
					<div class="dvSerie">
						<div class="imgDvSerie">
							<img src="<?=base_url()?><?=$masValorada->ruta_caratula?>" onerror="this.src='<?=base_url()?>assets/img/404.png';" alt="Imagen no encontrada" width="100%", height="100%"/>
						</div>
						<div class="h4DvSerie">
...
<div id="tabs-2">
    ...
    <!-- PELÍCULAS -->
        ...
        <div class="principalSerie_section-1 scroll">
			<div class="containerSeries" >
			<?php if(isset($pelisRecomendadas) && $pelisRecomendadas!=null):?>
				<?php foreach($pelisRecomendadas as $recomendacion):?>
					<div class="dvSerie" >
						<div class="imgDvSerie">
						...
						<div class="h4DvSerie">
							<form action="<?=base_url()?>pelicula/detalles" method="POST">
								...
								<button type="submit" value="Detalles" class="btnTitulo"><h4><?=$recomendacion->pelicula->nombre?></h4></button>
							</form>
						</div>
					</div>
				<?php endforeach;?>
        ...
        <div class="principalSerie_section-1 scroll">
			<div class="containerSeries" >
			<?php if(isset($seriesRecomendadas) && $seriesRecomendadas!=null):?>
				<?php foreach($seriesRecomendadas as $recomendacion):?>
					<div class="dvSerie" >
						<div class="imgDvSerie">
						...
						<div class="h4DvSerie">
							<form action="<?=base_url()?>serie/detalles" method="POST">
								...
								<button type="submit" value="Detalles" class="btnTitulo"><h4><?=$recomendacion->serie->nombre?></h4></button>
							</form>
						</div>
					</div>
				<?php endforeach;?>
        ...
        <div class="principalSerie_section-1 scroll">
			<div class="containerSeries" >
			<?php if(isset($musicasRecomendadas) && $musicasRecomendadas!=null):?>
				<?php foreach($musicasRecomendadas as $recomendacion):?>
					<div class="dvSerie" >
						<div class="imgDvSerie">
						...
						<div class="h4DvSerie">
							<form action="<?=base_url()?>musica/detalles" method="POST">
								...
								<button type="submit" value="Detalles" class="btnTitulo"><h4><?=$recomendacion->musica->nombre?></h4></button>
							</form>
						</div>
					</div>
				<?php endforeach;?>
        ...
        <div class="principalSerie_section-1 scroll">
			<div class="containerSeries" >
			<?php if(isset($librosRecomendados) && $librosRecomendados!=null):?>
				<?php foreach($librosRecomendados as $recomendacion):?>
					<div class="dvSerie" >
						<div class="imgDvSerie">
						...
						<div class="h4DvSerie">
							<form action="<?=base_url()?>libro/detalles" method="POST">
								...
								<button type="submit" value="Detalles" class="btnTitulo"><h4><?=$recomendacion->libro->nombre?></h4></button>
							</form>
						</div>
					</div>
				<?php endforeach;?>
