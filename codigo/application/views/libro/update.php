				...
				<form action="<?=base_url()?>libro/updatePost" method="POST" enctype="multipart/form-data" name="miForm">
					...
					<div class="modal-body">					
						...
						<div id="errorNombre"></div>
							...
							<label><span>*</span>Editorial:</label>
							...
							<label><span>*</span>Fecha de publicación:</label>
							<input type="text" class="form-control form-control-sm" name="fecha" id="fechaAn" value="<?=$libro->fecha ?>">
							...
							<br><br>
							<input type="button" class="btn btn-info" value="Actualizar" onclick="validarForm('libro')">
						</div>
					</div>
