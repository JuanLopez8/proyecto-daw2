...
<!-- si el usuario activo es el creador del libro, se mostrará un botón para que pueda editarlo -->
	<?php if(isset($_SESSION['id']) && isset($libro->usuario_id)):?>
	<?php if($_SESSION['id']==$libro->usuario->id):?>
	<form action="<?=base_url()?>libro/update" method="POST">
	<input type="hidden" name="id" value="<?=$libro->id?>"/>
	<input type="hidden" name="idUsu" value="<?=$_SESSION['id']?>"/>
	<input type="submit" class="btn btn-success" value="Actualizar información de mi libro"/>
	</form>
	<?php endif;?>
	<?php endif;?>
	...
	<?php endif;?>
		...
		<span class="tituloB">Número de páginas: <?=$libro->numero_paginas ?></span>
		<!-- Valoraciones -->
...
<?php endif;?>
	...
	<?php endif;?>
		...
		<div class="comentarios">
			...
			<?php if(isset($_SESSION['rol']) && $_SESSION['rol']=="administrador"):?>
			<form action="<?=base_url()?>libro/deleteComentario" method="POST">
