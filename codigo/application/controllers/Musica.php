...
class Musica extends CI_Controller
{
    ...
    public function listar()
    {
        ...
        if(isset($_SESSION['id'])){
            $data['seguidas']=$this->musica_model->getMusicasEstado('seguir', $_SESSION['id']);
             ...
             $data['recomendaciones']=$this->musica_model->getMusicasRecomendadas($_SESSION['id']);
         }
    ...
    public function updatePost()
    {
        ...
        $grupo_nuevo = isset($_POST['autor']) && ! empty($_POST['autor']) ? $_POST['autor'] : null;
        ...
        if ($nombre_nuevo!=null && $album_nuevo!=null && $grupo_nuevo!=null && $genero_nuevo!=null && $duracion_nuevo!=null && $fecha_nuevo!=null) {
            $this->load->model('musica_model');
            $ok = $this->musica_model->update($id, $nombre_nuevo, $grupo_nuevo, $album_nuevo, $genero_nuevo, $duracion_nuevo, $fecha_nuevo, $usuario, $imagenes);
            if ($ok) {
    ...
    public function deleteComentario(){
        ...
        if($id!=null){
            $this->load->model('musica_model');
            $this->musica_model->deleteComentario($id);
        }
        header("location: ".base_url()."musica/listar");
    }
}
