...
class Pelicula extends CI_Controller
{
    ...
    public function listar()
    {
        ...
        if(isset($_SESSION['id'])){
            ...
            $data['recomendaciones']=$this->pelicula_model->getPeliculasRecomendadas($_SESSION['id']);
        }
    ...
    public function delete() {
        ...
        if ($id != null) {
            ...
            header("location: ".base_url()."pelicula/listar");
        }
    }
    ...
    public function deleteComentario(){
        ...
        if($id!=null){
            $this->load->model('pelicula_model');
            $this->pelicula_model->deleteComentario($id);
        }
        header("location: ".base_url()."pelicula/listar");
    }
}
