...
class Libro extends CI_Controller
{
    ...
    public function listar()
    {
        ...
        if(isset($_SESSION['id'])){
            $data['seguidas']=$this->libro_model->getLibrosEstado('seguir', $_SESSION['id']);
             ...
             $data['recomendaciones']=$this->libro_model->getLibrosRecomendados($_SESSION['id']);
         }
    ...
    public function updatePost()
    {
        ...
        if ($nombre_nuevo!=null && $descripcion_nuevo!=null && $genero_nuevo!=null && $numero_paginas_nuevo!=null && $autor_nuevo!=null && $editorial_nuevo!=null && $fecha_nuevo!=null) {
            $this->load->model('libro_model');
            $ok = $this->libro_model->update($id, $nombre_nuevo, $descripcion_nuevo, $genero_nuevo, $numero_paginas_nuevo, $autor_nuevo, $editorial_nuevo, $fecha_nuevo, $usuario, $imagenes);
            if ($ok) {
    ...
    public function deleteComentario(){
        ...
        if($id!=null){
            $this->load->model('libro_model');
            $this->libro_model->deleteComentario($id);
        }
        header("location: ".base_url()."libro/listar");
    }
}
